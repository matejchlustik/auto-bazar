describe('Adding new offer', () => {
  ...
  it("Adds new offer and redirects user to homepage", () => {
    ...
    cy.get('[data-cy="year"] > input').type("2020")
    ...
    cy.get('[data-cy="postal_code"] > input').type("811 03")
    cy.get('[data-cy="number"] > input').type("+421 156 666")
    cy.get('[data-cy="email"] > input').type("jankol@gmail.com")
